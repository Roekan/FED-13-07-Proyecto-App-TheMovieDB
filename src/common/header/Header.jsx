          ...
          <Row className='d-flex align-items-center justify-content-around '>
            ...
            <Col  xs={12} md={6} lg={6}>
              <Row className=' d-flex align-items-center justify-content-around  py-1 '>
                <Col className='d-flex align-items-center justify-content-center box-link-header' xs={3}> <a href="/FED-13-07-Proyecto-App-TheMovieDB/" className='link-header' >Home</a> </Col>
